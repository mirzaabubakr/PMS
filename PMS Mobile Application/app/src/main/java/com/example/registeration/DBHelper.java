...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public boolean updatePassword(String email, String oldpas,String newPass){
        String[] params = new String[]{email, oldpas};
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put("UR_Password", newPass );
        db.update("registration", contentValues, "UR_Email = ? and UR_Password = ?", params);
        return true;
    };
